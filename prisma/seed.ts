...
async function main() {
  ...
  const providers = [
    ...
    { slug:'bokashi',      name:'Bokashi',           initials:'BK', color:'#F18F01', logo:'/images/providers/bokashi.png', status:'active', description:'Pupuk organik hasil fermentasi yang kaya akan mikroorganisme dan nutrisi.',              harga:15000, kandunganNutrisi:3.8, kualitas:7, dampak:7, ramahLingkungan:9, ketersediaan:7 },
  ]
